<?php
	function paginate($page, $tpages, $adjacents) {
		...
		if($page==1) {
			...
			$out.= "<li class='previous'><span><a href='javascript:void(0);' onclick='load(1)'>$previous</a></span></li>";
		}else {
			$out.= "<li class='previous'><span><a href='javascript:void(0);' onclick='load(".($page-1).")'>$previous</a></span></li>";
		...
		if($page<$tpages) {
			$out.= "<li class='next'><span><a href='javascript:void(0);' onclick='load(".($page+1).")'>$next</a></span></li>";
		}else {
